...
def cash_on_hand():
    ...
    if is_increasing:
        ...
        lines.append(f"[HIGHEST CASH DEFICIT] DAY: {top_3_deficits[-1][1]}, AMOUNT: USD {top_3_deficits[-1][0]}")
        lines.append(f"[2ND HIGHEST CASH DEFICIT] DAY: {top_3_deficits[-2][1]}, AMOUNT: USD {top_3_deficits[-2][0]}")
        lines.append(f"[3RD HIGHEST CASH DEFICIT] DAY: {top_3_deficits[-3][1]}, AMOUNT: USD {top_3_deficits[-3][0]}")
    return lines
