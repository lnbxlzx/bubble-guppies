...
def profit_and_loss(): 
    ...
    if is_increasing: 
        ...
        lines.append(f"[HIGHEST NET PROFIT DEFICIT] DAY: {top_3_deficits[0][1]}, AMOUNT: SGD {top_3_deficits[0][0]}") 
        lines.append(f"[2ND HIGHEST NET PROFIT DEFICIT] DAY: {top_3_deficits[1][1]}, AMOUNT: SGD {top_3_deficits[1][0]}") 
        lines.append(f"[3RD HIGHEST NET PROFIT DEFICIT] DAY: {top_3_deficits[2][1]}, AMOUNT: SGD {top_3_deficits[2][0]}") 
    return lines15:47
